...
BUTTON bottomSingleBtn = {
  ...
  POPUP_RECT_SINGLE_CONFIRM, NULL, 5, 1, 0xDBA0, 0xFC20, BLACK,   0xDBA0, BLACK, 0xFC20
};
BUTTON bottomDoubleBtn[] = {
  {POPUP_RECT_DOUBLE_CONFIRM, NULL, 5, 1, 0xDBA0, 0xFC20, BLACK,   0xDBA0, BLACK, 0xFC20},
  {POPUP_RECT_DOUBLE_CANCEL,  NULL, 5, 1, 0xDBA0, 0xFC20, BLACK,   0xDBA0, BLACK, 0xFC20},
};
BUTTON bottomThreeBtn[] = {
  {POPUP_RECT_THREE_CONFIRM, NULL, 5, 1, 0xDBA0, 0xFC20, BLACK,   0xDBA0, BLACK, 0xFC20},
  {POPUP_RECT_THREE_CANCEL,  NULL, 5, 1, 0xDBA0, 0xFC20, BLACK,   0xDBA0, BLACK, 0xFC20},
  {POPUP_RECT_THREE_DELETE,  NULL, 5, 1, 0xDBA0, 0xFC20, BLACK,   0xDBA0, BLACK, 0xFC20},
};
...
WINDOW window = {
  ...
  10,                      //
  3,                       //
  0x18e3,                  // 0x5D7B changed to orange
  {0xFC00, 0x18e3, POPUP_TITLE_HEIGHT},   //
  {WHITE, BLACK, POPUP_TEXT_HEIGHT},    //
  {WHITE, 0x18e3,  POPUP_BOTTOM_HEIGHT},  // changed to a darker gray color
};
  ...
  switch(key_num)
  {
    ...
    default:
    {
      switch(ABL_STATUS)
      {
        ...
        case ABL_START:
        {
          if(queue.ring_buffer.length>0){break;}
          key_lock = true;    // 触摸锁打开
          storeCmd("G28");    // home 
