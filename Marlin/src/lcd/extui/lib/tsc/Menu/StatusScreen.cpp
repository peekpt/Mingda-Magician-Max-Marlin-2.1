...
void drawStatusScreenMsg(void)
{
  ...
  //GUI_SetBkColor(MD_GRAY); #edited the background color of status message area to match the icons background
  GUI_SetBkColor(0x18e3); // darker color 
