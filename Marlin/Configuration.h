...
#define CUSTOM_MACHINE_NAME "MAGICIAN MAX"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_BED_KP 92.05
  #define DEFAULT_BED_KI 17.98
  #define DEFAULT_BED_KD 314.20
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 416.6 } // calibrated value extruder in 100mm of filament
 ...
 */
// The Magician Max uses a proprietary 480x320 FSMC TFT driven by the
// custom MD_FSMC_LCD UI (see src/lcd/extui/lib/tsc), so Marlin's generic
// TFT driver and UI selection are not used.
//#define TFT_GENERIC
