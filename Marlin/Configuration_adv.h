...
//#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  25.60       // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.15       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  50.40       // (Hz) The default dominant resonant frequency on the Y axis.
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.052 }   // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.052       // (mm) Compression length applying to all extruders
  #endif
 ...
 */
   ...
   */
  //#define STEALTHCHOP_XY   // X/Y in spreadCycle: more torque, robust against sync loss on direction changes
